  ...
  (function($) {
    ...
    FSP = (function() {
      ...
      FSP.prototype.init = function(event) {
        ...
        this.getTarget();
        this.setPopupHtml(event.target);
        this.getTargetSizes();
        this.createWrappers();
        this.wrapTarget();
      ...
      FSP.prototype.setPopupHtml = function(elementClicked) {
        if (this.options.updatePopup) {
          this.options.updatePopup(this.target, elementClicked);
        }
      };
      ...
      FSP.prototype.bindEvents = function() {
        this.body.on('keydown.popup', this.closePopup);
