...
<head>
	...
	<meta content='Sangu Package is een Greasemonkey script om het spelen van Tribal Wars sneller, efficiënter en aangenamer te laten verlopen' name='description'>
	<meta content="TribalWars Tribal Wars Stämme Greasemonkey UserScript free Sangu Package TW die-staemme" name="keywords">
	<style>
	#versionCheckResult {   display: none;  border: 1px solid black;    width: 350px;   height: 45px;}
	</style>
</head>
<body>
		...
		<tr>
			<td>
				<table border="0" width="100%">
					<tr>
						<td width="1%">
							<a href="http://nl.twstats.com/nl10/index.php?page=tribe&id=22147&tab=info" target="_blank"><img src="images/sangu.jpeg"></a>
						</td>
						<td valign="top">
							<h1>Sangu Package</h1>Het Sangu Package is een Greasemonkey script (voor Opera, Firefox en Chrome) dat beweert het spelen van TW sneller, vlotter en efficiënter te laten verlopen en dat, zoals de naam al doet vermoeden, een verzameling is van scripts die de bestaande TW pagina's gaan uitbreiden met vooral extra berekeningen (afstanden, tijden, stacks) en sorteer, groepeer- en filtermogelijkheden. Het Sangu Package is gericht naar grote spelers (50+ dorpen) en is ook meer actief op PA pagina's.<br>
							<br>
				...
				<div id='versionCheckResult'></div>
				<h1>Donatie</h1>
				<table border="0" width="100%">
					<tr>
						<td width="1%">
							<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
								<input name="cmd" type="hidden" value="_s-xclick"><input name="hosted_button_id" type="hidden" value="ZJJ7HPMSQ3KAW"><input height='21' name="submit" src="https://www.paypal.com/en_US/i/btn/btn_donate_SM.gif" title="PayPal - The safer, easier way to pay online!" type="image" width='74'><img alt="" border="0" height="1" src="https://www.paypal.com/en_US/i/scr/pixel.gif" title="" width="1">
							</form>
						</td>
						<td>
							Je vindt het Sangu Package leuk en die appreciatie wil je met de maker delen?<br>
							Dat kan - volledig vrijblijvend - via mijnPaypal account of mijn <a href="http://www.amazon.com/wishlist/1RFQ21NSF4PAI/ref=cm_wl_prev_ret?_encoding=UTF8&reveal=" target="_blank">Amazone wishlist</a> :)
						</td>
					</tr>
				</table>
...
<!--
TODO: dit kan naar de Sangu pagina 'folklore'
