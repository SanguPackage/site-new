...
// @icon            https://www.sangu.be/favicon.png
// @include         https://*.tribalwars.*/game.php?*
// @include         https://*.fyletikesmaxes.gr/game.php*
// @include         https://sangu.be/*
// @include         https://www.sangu.be/*
// @version         8.233.3
...
function sangu_ready() {
	...
	link.one('click', function () {
        ...
        html += "De Goede Fee, Tjeerdo, cgrain, Hardcode93, martijn1279, Joeri Boons, ToxicDonut95";
				        html += "</b>";
...
(function() {
    ...
    if (lastVersion.length === 1) {
        ...
        if ('8.233.3'.indexOf(lastVersion.text()) === 0) {
